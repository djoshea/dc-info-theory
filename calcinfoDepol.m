...
compare(3).fnum = '0020';
compare(3).name = 'Depolarized';
compare(3).color = [0.4 0.4 0.4];
...
for cm = 1:length(compare)
    ...
    % load the CC traces
    fname = sprintf('/Users/djoshea/Documents/Research/dLab/dlab data/2010_07_09/2010_07_09_%s.atf', compare(cm).fnum);
    [traces{cm} epscs time si] = loadinfoatf(fname);
